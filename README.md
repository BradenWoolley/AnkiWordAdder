...
###Lastly the application can clear the text file of words once adding them has been completed.
###Anyone is free to use this app and modify it as they wish. For another language the Serbian character buttons will need to be replaced or removed.
